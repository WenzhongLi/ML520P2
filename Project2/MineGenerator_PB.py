...
class Generator(object):
    ...
    def paint_random(self):
        ...
        for node in mine_and_blank_set:
            matrix[node[0]][node[1]] = -4  # means no information
        self.map_matrix = matrix
        self.print_matrix()
        # get some point randomly
        mine_set = random.sample(mine_and_blank_set, mine_num)
...
if __name__ == "__main__":
    ...
    generator = Generator(10, 15, 0.15, 0.05)
